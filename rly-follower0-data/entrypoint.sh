...
AWS_ENDPOINT_URL=http://kms:8080 centralized-relay keystore import --chain constantine-3 --keystore /home/relayer/wallets/archway-follower0.json --password password
sleep 3
